...
public class Starter {
    public static void main(String[] args) throws Exception {
            ...
            public void configure() throws Exception {
                from("timer:base?period=60000")
                        ...
                        .process(exchange -> {
                            ...
                            message.setHeader("rmd", "kek");
                            message.setBody(body.toString() + "\n" + in.getHeaders().toString());

                            exchange.setMessage(message);

                        })
                            .toD("file://C:/java/javaProjects/sources/camel-app/files/toB?fileName=done-${date:now:yyyyMMdd}-${headers.rmd}.txt");
        ...
        template.sendBody("file://C:/java/javaProjects/sources/camel-app/files?filename=event-${date:now:yyyyMMdd-HH-mm}.html"
                ,"<hello>world!</hello>");
